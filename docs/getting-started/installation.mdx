...
Ensure the framework CLI from `go install github.com/mithril-framework/mithril/cmd/mithril@v1.0.2` is first on PATH. See [Quick Start troubleshooting](/docs/getting-started/quick-start#troubleshooting).
