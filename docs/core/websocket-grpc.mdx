...
WebSocket and gRPC support are on the roadmap. This page describes the planned API — not yet implemented in the framework.
</PlannedFeatureBanner>

Mithril will provide real-time communication through WebSocket and high-performance RPC through gRPC.
